...
namespace ades {
    ...
    class MotionSequence2_1 : public Serializable
    {
    private:
        uint64_t ID;
        std::map<std::string, std::string> inputTypes_;
    ...
    public:
        /*! Constructor for type ades::MotionSequence2_1.
         ...
         */
        MotionSequence2_1(std::map<std::string, std::string> inputTypes = std::map<std::string, std::string>(),
         ...
         */
        void insertInputTypes(const std::map<std::string, std::string> inputTypes);
         ...
         */
        std::map<std::string, std::string> getInputTypes() const
        {
            return inputTypes_;
        }
         ...
         *  \exception std::out_of_range : if the MotionSequence2_1 does not have an motion
